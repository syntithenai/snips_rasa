...
do
    ...
    then
        ...
        sed -i "s#Host = localhost#Host = $SNIPS_MQTT_HOST#" /root/resources/snips.ini
        sed -i "s#Port = 1883#Port = $SNIPS_MQTT_PORT#" /root/resources/snips.ini
        SNIPS_MQTT_FLAG="--bus '$SNIPS_MQTT_HOST:$SNIPS_MQTT_PORT'"
